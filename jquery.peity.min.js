...
z.restore(),y.tooltip(z,d.x,d.y,[c[v]],[x.call(this,c[v],v,c)],a.size,a.color,a.formatter)),K(n))});w.register("lines",{lineColors:["#78A","#827"],lineWidths:[1],fill:"#cdf",delimiters:["|",","],height:32,width:32,left:0,max:null,min:0,pointSizes:[2],xAxis:u.defaultText,yAxis:u.defaultText,tooltip:u.defaultText,focus:!1,gridlines:{widths:[1,0],colors:["#000","#bbb"]}},function(a){var b=this.$el.data("mouse"),c=this.values.apply(this,a.delimiters),e,f=a.pointSizes,d=a.xAxis,g=a.yAxis,h=a.focus,q=a.tooltip,
