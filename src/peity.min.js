...
b);a.arc(b,b,b,0,Math.PI*2);a.closePath();a.fillStyle=d.colours[0];a.fill();a.beginPath();a.moveTo(b,b);a.arc(b,b,b,g,i+g);a.closePath();a.fillStyle=d.colours[1];a.fill();c(this).trigger("chart:changed",[e,f])});c(this).trigger("change");return this};c.fn.peity.defaults={colours:["FFF4DD","FF9900"],delimeter:"/",radius:16}})(jQuery);
