...
strokeWidth:1,delimeter:",",height:16,max:null,width:32},function(c,b){var a=document.createElement("canvas");a.setAttribute("width",b.width);a.setAttribute("height",b.height);c.wrapInner("<span />").append(a);c=e("span",c).hide().text().split(b.delimeter);var d=Math.max.apply(Math,c.slice(0).concat([b.max]));d=b.height/d;var h=b.width/(c.length-1),g=[],f=a.getContext("2d");f.beginPath();f.moveTo(0,b.height);for(a=0;a<c.length;a++){var i=a*h,j=b.height-d*c[a];g.push({x:i,y:j});f.lineTo(i,j)}f.lineTo(b.width,
b.height);f.fillStyle=b.colour;f.fill();f.beginPath();f.moveTo(0,g[0].y);for(a=0;a<g.length;a++)f.lineTo(g[a].x,g[a].y);f.lineWidth=b.strokeWidth;f.strokeStyle=b.strokeColour;f.stroke()});e.fn.peity.add("bar",{colour:"#4D89F9",delimeter:",",height:16,max:null,width:32},function(c,b){var a=document.createElement("canvas");a.setAttribute("width",b.width);a.setAttribute("height",b.height);c.wrapInner("<span />").append(a);c=e("span",c).hide().text().split(b.delimeter);var d=Math.max.apply(Math,c.slice(0).concat([b.max]));
d=b.height/d;var h=b.width/c.length;a=a.getContext("2d");a.fillStyle=b.colour;for(var g=0;g<c.length;g++){var f=d*c[g];a.fillRect(g*h,b.height-f,h,f)}})})(jQuery);
